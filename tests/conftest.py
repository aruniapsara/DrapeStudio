"""Pytest fixtures: test client, DB session."""
...
os.environ["DATABASE_URL"] = "sqlite:///./test_drapestudio.db"
...
# Test database
TEST_DATABASE_URL = "sqlite:///./test_drapestudio.db"
...
def sample_image_bytes():
    """Return bytes of a small valid JPEG image for testing."""
    fixtures_dir = os.path.join(os.path.dirname(__file__), "fixtures")
    sample_path = os.path.join(fixtures_dir, "garment_sample.jpg")
    if os.path.exists(sample_path):
        with open(sample_path, "rb") as f:
            return f.read()
    # Fallback: create a minimal JPEG-like bytes for testing
    # This is a minimal valid JPEG (1x1 pixel, red)
    return (
